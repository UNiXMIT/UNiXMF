...
-H "Origin: http://localhost:10086" ^
-b "C:\Users\Public\Documents\cookieFile.txt" ^
-d "{\"CN\": \"ADLDS\", \"description\": \"ADLDS ESM\", \"mfESMModule\": \"mdlap_esm\", \"mfESMConnectionPath\": \"localhost:389\", \"mfESMID\": \"Administrator\", \"mfESMPwd\": \"strongPassword123\", \"mfESMStatus\": \"Enabled\", \"mfESMCacheLimit\": 1024, \"mfESMCacheTTL\": 600, \"mfConfig\": \"[LDAP]\nbind=negotiate\nBASE=CN=Micro Focus,CN=Program Data,DC=local\nuser class=microfocus-MFDS-User\nuser container=CN=Enterprise Server Users\ngroup container=CN=Enterprise Server User Groups\nresource container=CN=Enterprise Server Resources\n\n[Operation]\nset login count=yes\nsignon attempts=3\n\n[Verify]\nMode=MF-hash\n\n[Trace]\nModify=y\nRule=y\nGroups=y\nSearch=y\nBind=n\nTrace1=verify:*:debug\nTrace2=auth:*:*:**:debug\"}"